...
namespace StationeryStoreUILayer
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            OrderManagerForm orderManagerForm = new OrderManagerForm(new OrdersDataGeter(),orderSearcher,orderDeleter,new DgOrdersFillerByDeliveryState(new MiladiToPersianDateConvertor()),new TextBoxRestartor(),new ComboRestartor(),new NumericUdRestartor(),new MaskedTextBoxRestartor(),new BoolComboFiller(),new NumericUdDefaultValueSeter(),orderCanceler,new OrderInfoFormOpener<OrderInfoForm>(orderInfoForm));
