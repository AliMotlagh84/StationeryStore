...
namespace StationeryStoreUILayer
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            IOrderCancelingHandler orderCancelingHandler = new OrderCancelingHandler(new OrdersDataGeter(),orderSearcher,new OrderDataDeleter());
            ...
            OrderManagerForm orderManagerForm = new OrderManagerForm(new OrdersDataGeter(),orderSearcher,new OrderDataDeleter(),new DgOrdersFillerByDeliveryState(new MiladiToPersianDateConvertor()),new TextBoxRestartor(),new ComboRestartor(),new NumericUdRestartor(),new MaskedTextBoxRestartor(),new BoolComboFiller(),new NumericUdDefaultValueSeter(), orderCancelingHandler);
