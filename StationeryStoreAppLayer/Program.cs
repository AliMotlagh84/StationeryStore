...
namespace StationeryStoreAppLayer
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            BrandAdderOrEditorForm brandAdderOrEditorForm = new BrandAdderOrEditorForm(new BrandDataBuilder(),brandEditor,new NullOrWhiteSpaceValidator(),new TextBoxFiller(),new ButtonTextSeter(),new FormTextSeter(),new TextBoxRestartor());
            ...
            StoreManagerForm storeManagerForm = new StoreManagerForm(new ProductsManagerFormOpener<ProductsManagerForm>(productsManagerForm),new BrandsManagerFormOpener<BrandsManagerForm>(brandsManagerForm));
