...
using StationerStoreApplicationLayer.DataDeleter.OrderDataDeleters;
...
namespace StationeryStoreUILayer
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            IUserEditor userEditor = new UserEditor(new UserDataEditor(),new OrdersDataGeter(),orderSearcher,new OrderDataEditor(),new DraftOrderDataGeter(),draftOrderSearcher,new DraftOrderDataEditor(),new AdressesDataGeter(),adressSearcher,new AdressDataEditor());
            ...
            IProductCountEditByDraftOrderDelete productCountEditByDraftOrderDelete = new ProductCountEditByDraftOrderDelete(new ProductDataGeterById(), new ProductDataBuilder(), productEditor); IUserSeacher userSearcher = new UserSeacher(new UserSearcherByUserName(), new UserSearcherByUserId(), new UserSearcherByPassword(), new UserSearcherByEmail(), new UserSearcherByAdminiState());
            ...
            IOrderDeleter orderDeleter = new OrderDeleter(new JsonToDrfatOrderRestorer(new DraftOrderDTOToDraftOrderEfEntityMapper()), new OrderDataDeleter(), productCountEditByDraftOrderDelete);
            ...
            IProductDeleter productDeleter = new ProductDeleter(new ProductDataDeleter(), new DraftOrderDataGeter(), draftOrderSearcher, draftOrderDeleter);
            IUserDeleter userDeleter = new UserDeleter(new UserDataDeleter(), new DraftOrderDataGeter(), draftOrderSearcher, draftOrderDeleter,new AdressesDataGeter(),adressSearcher,new AdressDataDeleter(),new OrdersDataGeter(),orderSearcher,orderDeleter);
            IBrandDeleter brandDeleter = new BrandDeleter(new BrandDataDeleter(), new ProductsDataGeter(), productSearcher, productDeleter, new DraftOrderDataGeter(), draftOrderSearcher, draftOrderDeleter);
            IOrderAdder orderAdder = new OrderAdder(new OrderDataAdder(),new DraftOrderDataGeter(), draftOrderSearcher,new DraftOrderDataDeleter());
            IOrderCanceler orderCanceler = new OrderCanceler(new OrdersDataGeter(), orderSearcher, orderDeleter);
            OrderInfoForm orderInfoForm = new OrderInfoForm(new DgFiller(),new JsonToDrfatOrderRestorer(new DraftOrderDTOToDraftOrderEfEntityMapper()));
            ...
            IAdressChooserFormOpeningHandler adressChooserFormOpeningHandler = new AdressChooserFormOpeningHandler(new AdressAdderOrEditorFormOpener<AdressAdderOrEditorForm>(adressAdderOrEditorForm), new AdressChooserFormOpener<AdressChooserForm>(adressChooserForm), new AdressesDataGeter(),adressSearcher,new DraftOrderDataGeter(),draftOrderSearcher);
            IDgOrdersFillingHandler dgOrdersFillingHandler = new DgOrdersFillingHandler(new OrdersDataGeter(),orderSearcher,new DgOrdersFillerByDeliveryState(new MiladiToPersianDateConvertor()));
