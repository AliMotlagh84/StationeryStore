...
namespace StationeryStoreAppLayer
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            ShoppingCartForm shoppingCartForm = new ShoppingCartForm(new DraftOrderDataGeter(), draftOrderSearcher,new DraftOrderDataDeleter(),new DraftOrderDataBulider(),new DgFiller());
